...
predicate :: Predicate -> ([LispVal] -> LispVal)
predicate p = Bool . fn where 
  fn [x] = p x
  fn _   = False
...
symbolName :: [LispVal] -> Maybe String
symbolName [Atom name] = Just name
symbolName _           = Nothing

symbolOp :: (String -> LispVal) -> [LispVal] -> LispVal
symbolOp f = maybe (Bool False) f . symbolName
